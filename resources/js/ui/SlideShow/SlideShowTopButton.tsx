...
const SlideShowTopButton = ({ totalSlides, 
  visibleSlides, 
  currentSlide, 
  children ,  
  isPlaying = false,
  infinite = false,
  interval = 2000 }: Properties) => {
      ...
      >
        <div className='flex w-full justify-end gap-5 px-5'>
          <ButtonBack
            ...
            className='flex cursor-pointer items-center justify-center rounded-full bg-transparent p-3
...
export default SlideShowTopButton
