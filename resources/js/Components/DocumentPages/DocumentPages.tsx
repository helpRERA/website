    ...
    <div className="paper-container" id="preview-content">
      ...
      <div className="paper-page">
        ...
        <div className="page-content">
          ...
          <p style={{ textIndent: '2rem' }}>
            Use of Basement and Service Areas.— The basement(s) and service areas, if any, as located within the <SpanVal val={projectName} fieldKey="projectName" /> (Project name) shall be earmarked for purposes such as parking spaces and services including but not limited to electric sub-station, transformer, DG set rooms, underground water tanks, pump rooms, maintenance and service rooms, fire fighting pumps and equipment's etc. and other permitted uses as per sanctioned plans. The Allottee shall not be permitted to use the services areas and the basements in any manner whatsoever, other than those earmarked as parking spaces, and the same shall be reserved for use by the association of allottees formed by the Allottees for rendering maintenance services.
          </p>
