              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-1 lg:flex-none flex flex-col items-center justify-center py-2.5 lg:py-5 px-1 lg:px-3 rounded-lg border transition-all duration-300 lg:shrink-0 gap-1 lg:gap-2 whitespace-nowrap ${isActive
                ...
                {filterOptions.map((opt) => {
                  ...
                  return (
                    <label key={opt} className="flex items-center cursor-pointer group">
                      <div className={`w-5 h-5 rounded-[4px] flex items-center justify-center border border-[#085484] transition-colors ${isChecked ? 'bg-[#E6F3FB]' : 'bg-white'
                        }`}>
                        {isChecked && (
