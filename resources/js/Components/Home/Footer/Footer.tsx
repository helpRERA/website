          ...
          <div className='grid grid-cols-1 gap-6 lg:grid-cols-5'>
            ...
            <div className='lg:col-span-1 flex flex-col gap-4'>
              ...
              <div className='flex items-center gap-3 mt-1'>
                <span className='text-[#444] text-[15px]'>Let's Connect:</span>
            ...
            <div>
              ...
              <ul className='space-y-2.5 text-[14px] md:text-[15px] text-[#555]'>
                ...
                <li className='flex items-center gap-2.5'>
                  ...
                  <a href="mailto:info.rerakerala@gmail.com" className="hover:text-[#085484] transition-colors">info.rerakerala@gmail.com</a>
                </li>
              </ul>
            </div>
          </div>
