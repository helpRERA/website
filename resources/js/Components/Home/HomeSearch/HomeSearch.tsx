              ...
              <div>
                ...
                >
                  ...
                  <div className='mt-4 w-full justify-end sm:mt-0 sm:flex sm:w-5/12'>
                    <Link
                      as='button'
                      className='f-m-m w-full rounded bg-primary-900 px-4 py-2.5 text-base font-normal leading-4 text-white hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-offset-2 sm:w-auto md:py-2 md:px-8 md:text-base'
