  ...
  return (
    <ReactLenis root>
      ...
      <div className='fixed right-0 top-1/3 z-[9999] flex flex-col gap-2'>
        <button className='flex h-8 w-8 md:h-12 md:w-12 items-center justify-center rounded-l-[10px] md:rounded-l-[16px] bg-[#085484] shadow-lg transition hover:bg-[#0b1e3b] p-1.5 md:p-2.5'>
